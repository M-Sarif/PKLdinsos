...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $id_pengguna = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;
    ...
    $query = "INSERT INTO pengajuan (id_pengguna, nomor_kk, alamat, rt, rw, desa, kecamatan, sktm, dtks, kartu_keluarga, ktp)
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($mysqli, $query);
    mysqli_stmt_bind_param($stmt, "issssssssss", $id_pengguna, $nomor_kk, $alamat, $rt, $rw, $desa, $kecamatan, $sktm_filename, $dtks_filename, $kartu_keluarga_filename, $ktp_filename);
